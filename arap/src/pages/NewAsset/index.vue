          ...
          <div class="form-rows">
            ...
            <div v-if="AssetType === 'Software'">
              ...
              <el-row gutter="{20}">
                ...
                <el-col :span="10" offset="2">
                  <el-text class="q-text"
                    >External Supplied<span class="required-asterisk">*</span
                    >:</el-text
                  >
                  <el-select
            ...
            <div v-if="AssetType === 'Physical'">
              ...
              <div v-if="physicalAssetType === 'Fixed'">
                <el-row gutter="{20}">
                  <el-col :span="10">
                    <el-text class="q-text"
                      >Asset Category (Fixed)<span class="required-asterisk"
                        >*</span
                      >:</el-text
                    >
                    <el-select
                ...
                <el-row gutter="{20}">
                  <el-col :span="10">
                    <el-text class="q-text"
                      >Purchase Date<span class="required-asterisk">*</span
                      >:</el-text
                    >
                    <el-date-picker
                ...
                <el-row gutter="{20}">
                  <el-col :span="10">
                    <el-text class="q-text"
                      >Maintenance Cycle<span class="required-asterisk">*</span
                      >:</el-text
                    >
                    <el-select
                  ...
                  <el-col :span="10" offset="2">
                    ...
                    >
                      ...
                      <el-option
                        ...
                        value="Industrial Control Devices"
                      />
                      <el-option
                        label="Office Computers"
                        value="Office Computers"
                      />
                      <el-option
              ...
              <div v-if="physicalAssetType === 'Non-fixed'">
                <el-row gutter="{20}">
                  <el-col :span="10">
                    <el-text class="q-text"
                      >Asset Category (Non-fixed)<span class="required-asterisk"
                        >*</span
                      >:</el-text
                    >
                    <el-select
                ...
                <el-row gutter="{20}">
                  <el-col :span="10">
                    <el-text class="q-text"
                      >Checkout Date<span class="required-asterisk">*</span
                      >:</el-text
                    >
                    <el-date-picker
                  ...
                  <el-col :span="10" offset="2">
                    <el-text class="q-text"
                      >Expected Return Date<span class="required-asterisk"
                        >*</span
                      >:</el-text
                    >
                    <el-date-picker
            ...
            <div v-if="AssetType === 'Information'">
              ...
              <el-row gutter="{20}">
                <el-col :span="10">
                  <el-text class="q-text"
                    >Retention Policy<span class="required-asterisk">*</span
                    >:</el-text
                  >
                  <el-select
                ...
                <el-col :span="10" offset="2">
                  <el-text class="q-text"
                    >Storage Location<span class="required-asterisk">*</span
                    >:</el-text
                  >
                  <el-input
                    style="width: 100%"
              ...
              <el-row gutter="{20}">
                <el-col :span="10">
                  <el-text class="q-text"
                    >Information Asset Type<span class="required-asterisk"
                      >*</span
                    >:</el-text
                  >
                  <el-select
                    v-model="informationAssetType"
              ...
              <div v-if="informationAssetType === 'Database'">
                <el-row gutter="{20}">
                  <el-col :span="10">
                    <el-text class="q-text"
                      >Data Schema<span class="required-asterisk">*</span
                      >:</el-text
                    >
                    <el-select
                      v-model="dataSchema"
                ...
                <el-row gutter="{20}">
                  <el-col :span="10">
                    <el-text class="q-text"
                      >Contains PII<span class="required-asterisk">*</span
                      >:</el-text
                    >
                    <el-select
                      v-model="containsPII"
              ...
              <div v-if="informationAssetType === 'Document'">
                <el-row gutter="{20}">
                  <el-col :span="10">
                    <el-text class="q-text"
                      >File Format<span class="required-asterisk">*</span
                      >:</el-text
                    >
                    <el-select
                      v-model="fileFormat"
            ...
            <div v-if="AssetType === 'People'">
              ...
              <el-row gutter="{20}">
                <el-col :span="10">
                  <el-text class="q-text"
                    >Hire Date<span class="required-asterisk">*</span>:</el-text
                  >
                  <el-date-picker
                    v-model="hireDate"
                    type="date"
                ...
                <el-col :span="10" offset="2">
                  <el-text class="q-text"
                    >Background Check Status<span class="required-asterisk"
                      >*</span
                    >:</el-text
                  >
                  <el-select
              ...
              <el-row gutter="{20}">
                <el-col :span="10">
                  <el-text class="q-text"
                    >Security Training Status<span class="required-asterisk"
                      >*</span
                    >:</el-text
                  >
                  <el-select
                ...
                <el-col :span="10" offset="2">
                  <el-text class="q-text"
                    >Employee Status<span class="required-asterisk">*</span
                    >:</el-text
                  >
                  <el-select
              ...
              <el-row gutter="{20}">
                <el-col :span="10">
                  ...
                  <el-input
                    style="width: 100%"
                    v-model="systemAccessPermissions"
                    placeholder="Please input"
                    clearable
                  />
                </el-col>
